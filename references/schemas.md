...
**How to capture:** When an executor task completes, the environment may expose `total_tokens` and `duration_ms` in its completion notification. Save these immediately when available — they are often not persisted anywhere else.
